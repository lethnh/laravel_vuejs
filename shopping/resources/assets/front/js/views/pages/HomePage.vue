      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/food_item/food_item_1.png" alt>
              </div>
              <div class="single_blog_text">
                ...
                <a href="#" class="btn_3">
                  Read More
                  <img src="/front/img/icon/left_2.svg" alt>
                </a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/food_item/food_item_2.png" alt>
              </div>
              <div class="single_blog_text">
                <h3>Cremy Noodles</h3>
                <p>Was brean shed moveth day yielding tree yielding day were female and</p>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/food_item/food_item_3.png" alt>
              </div>
              <div class="single_blog_text">
                <h3>Honey Meat</h3>
                <p>Was brean shed moveth day yielding tree yielding day were female and</p>
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-sm-4 col-lg-5 offset-lg-1">
            <div class="about_img">
              <img src="/front/img/about.png" alt>
            </div>
          </div>
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-lg-6">
            <div class="nav nav-tabs food_menu_nav" id="myTab" role="tablist">
              ...
              >
                Special
                <img src="/front/img/icon/play.svg" alt="play">
              </a>
              <a
                id="Breakfast-tab"
                data-toggle="tab"
          ...
          <div class="col-lg-12">
            <div class="tab-content" id="myTabContent">
              <div
                class="tab-pane fade show active single-member"
                id="Special"
                role="tabpanel"
              ...
              <div
                class="tab-pane fade single-member"
                id="Breakfast"
                role="tabpanel"
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/team/chefs_1.png" alt>
              </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/team/chefs_2.png" alt>
              </div>
              <div class="single_blog_text text-center">
                <h3>Fred Macyard</h3>
                <p>Chef Master</p>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/team/chefs_3.png" alt>
              </div>
              <div class="single_blog_text text-center">
                <h3>Justin Stuard</h3>
                <p>Chef Master</p>
            ...
            <div class="client_review_part owl-carousel">
              <div class="client_review_single media">
                <div class="client_img align-self-center">
                  <img src="/front/img/client/client_1.png" alt>
                </div>
                <div class="client_review_text media-body">
                  <p>
                    ...
                    also made from give
                    may saying meat. There from heaven it lights face had amazing place
                  </p>
                  <h4>
                    Mosan Cameron,
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/blog/blog_1.png" alt>
              </div>
              <div class="single_blog_text">
                <div class="date">
                  <a href="#" class="date_item">Apr 06, 2019</a>
                  <a href="#" class="date_item">
                    <span>#</span> Food News
                  </a>
                </div>
                <h3>
                ...
                <a href="#" class="btn_3">
                  Read More
                  <img src="/front/img/icon/left_1.svg" alt>
                </a>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/blog/blog_2.png" alt>
              </div>
              <div class="single_blog_text">
                <div class="date">
                  <a href="#" class="date_item">Apr 06, 2019</a>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="single_blog_item">
              <div class="single_blog_img">
                <img src="/front/img/blog/blog_3.png" alt>
              </div>
              <div class="single_blog_text">
                <div class="date">
                  <a href="#" class="date_item">Apr 06, 2019</a>
